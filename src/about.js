...
//  jQuery.getJSON('../craigdemartino.com/assets/content/about.json',function( data ) {
...
let data = 
{
    ...
    "sections": [
        {
            "title": "History",
            "body": "In 2002 my life changed dramatically. I was accidentally dropped 100 feet while climbing in CO. Thats the same hieght as a 10 story office building. I endured a three month stay in the hospital and later a rehab facility where I began to rebuild my life and body. After 18 months, I decided to amputate my leg below the knee to return to climbing, and the quality of life I once enjoyed. Now, with 30 years of climbing experience under my belt, I have a new and exciting view of the world. I believe perspective is a great tool to motivate us, and the accident gave me such perspective. Once I returned to climbing I pushed my body to learn and re-learn the art of climbing. That journey continues on."
        },
        {
            "title": "Records",
            "body": [
